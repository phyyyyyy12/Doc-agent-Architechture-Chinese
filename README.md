...
| **3. 推理引擎 (ReAct)** | [多模态 ReAct 推理引擎与双轨规划](./docs/react/index.md) | [从“泛用搜索”到“高精度闭环”](./docs/react/evolution.md) |
---
...
3. **自适应 ReAct 引擎**：自适应 ReAct 引擎：构建 Thought-Action-Observation 闭环推理，通过双轨规划机制（规则+LLM），在规避外部搜索噪声的同时，实现针对私有技术文档的高精度深度推理
